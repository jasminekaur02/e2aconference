...
>>>>>>> c69d2eda8715b61c2feb99fa69e5ba5a9c04726f
];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-6">
                ...
                {/* Menu button */}
<Disclosure.Button
  className={`inline-flex items-center px-4 py-2 bg-black text-white text-xl font-bold hover:bg-gray-800 focus:outline-none  ${
    open ? "fixed top-4 right-4 z-50" : ""
  }`}
>
  {open ? (
    <>
