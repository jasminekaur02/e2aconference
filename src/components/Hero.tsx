...
<div className="relative flex flex-col justify-center items-center text-center text-white h-full px-4 pt-32">
  <h1 className="text-5xl font-bold">E2ACon2025</h1>
