...
const sponsorshipPackages = [
  {
    ...
    price: "2.50 Lakhs",
    benefits: [
      "Opportunity of a maximum of 2 hours to address the audience to deliver an expert talk and panel session during the conference program.",
      "An entire website page dedicated to the contributor within the 'about' category.",
      ...
      "Four banners/standees received from contributors at the venue.",
      ...
      "Company logo displayed at the welcome reception, talent, networking event, and conference gala dinner.",
      "Contributor acknowledgment during the conference on banners and projector screens.",
    ],
  },
  {
    title: "Gold",
    price: "1.50 Lakhs",
    benefits: [
      "Opportunity of 1-hour duration address to the audience to deliver an expert talk or panel session during the conference program.",
      "An entire website page dedicated to the contributor within the 'about' category.",
      "The logo of the main contributor on the organizing banner displayed at the conference, website & on all conference marketing material.",
      "Contributor's brochure included in the conference kit.",
      "Two banners/standees received from contributors at the venue.",
      ...
      "The company logo will be displayed at the Welcome Reception, Talent and Networking Event, and conference Gala Dinner.",
      "Contributor acknowledgment during the conference on banners and projector screens.",
    ],
  },
  {
    ...
    price: "1 Lakh",
    benefits: [
      "The opportunity to address the audience for a 30-minute duration to deliver an expert talk or a panel session during the conference program.",
      "An entire website page dedicated to the contributor within the 'about' category.",
      "The logo of the main contributor on the organizing banner displayed at the conference, website & on all conference marketing material.",
      "Contributor's brochure included in the conference kit.",
      ...
      "One stall (3mx3m) for the contributor.",
      "Two (2) complimentary registrations for the conference, which include access to all technical sessions, daily working lunch, attendance at the welcome reception, talent and networking event, conference gala dinner, and closing ceremony.",
      "Company logo displayed at the welcome reception, talent, networking event, and conference gala dinner.",
      "Contributor acknowledgment during the conference on banners and projector screens.",
    ],
  },
