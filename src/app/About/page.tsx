        ...
        <section className="px-6 md:px-12 py-16 bg-white">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <a href="https://www.nitj.ac.in" target="_blank">https://www.nitj.ac.in</a></Link></p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <Link href="https://departments.nitj.ac.in/dept/ice/home" legacyBehavior>
                <a href="https://departments.nitj.ac.in/dept/ice/home" target="_blank">https://departments.nitj.ac.in/dept/ice/home</a></Link></p>
              <p className="text-md leading-relaxed text-justify">
